...
if net is not None:
    ...
    por(net, "RemoteAddress", "186.215.73.175:27040")   # host:porta do jogo
    por(net, "WebServerUrl", "http://186.215.73.175:27041")
    por(net, "Password", "")
...
if SECO:
    ...
    checagens = [
        ...
        ("Network.eco", "RemoteAddress", "186.215.73.175:27040"),
        ("Network.eco", "WebServerUrl", "http://186.215.73.175:27041"),
